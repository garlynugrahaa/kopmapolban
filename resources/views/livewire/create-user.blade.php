    ...
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="form">
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <x-jet-input id="fullname" type="text" class="mt-1 block w-full form-control shadow-none" wire:model.defer="user.fullname" />
                <x-jet-input-error for="user.fullname" class="mt-2" />
            </div>
